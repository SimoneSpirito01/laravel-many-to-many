                ...
                <div class="card-body">
                  <div class="new-post">
                    <form class="d-flex mb-3" action="{{route('tags.store')}}" method="POST">
                        ...
                        <div>
                            @csrf
                            <input value="{{old('name')}}" type="text" class="form-control id="name" placeholder="Insert the tag" name="name">
                        </div>
                        @error('name')
                                ...
                                <tr class="my_item">
                                    ...
                                    <td>
                                        ...
                                        <div class="name-input d-none">
                                            <form class="d-inline-block edit-form" action="{{route('tags.update', $tag)}}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <input value="{{$tag->name}}" type="text" class="form-control" id="name" placeholder="Insert the name" name="name">
                                            </form>
                                        </div>
                                    </td>
                                    <td>{{$tag->slug}}</td>
                                    <td>
                                        <button type="button" class="btn btn-info"><a class="text-white" href="{{route('tags.show', $tag->id)}}">View</a></button>
                                        <div class="edit-buttons d-inline-block">
                                            ...
                                            <button type="submit" class="btn btn-danger btnToggle btnP" data-toggle="modal" data-target="#exampleModal" data-slug="{{$tag->id}}">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                              @endforeach
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <form action="" method="POST" class="my_form">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-danger toastClicker delete-tag btnP" data-dismiss="modal">Confirm</button>
                                  </form>
                                </div>
                              </div>
                            </div>
